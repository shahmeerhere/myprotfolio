    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-20 px-6 text-center">
        ...
        >
          ...
          <Link
            href="/contact"
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-10 rounded-full transition-all shadow-[0_0_20px_rgba(37,99,235,0.4)] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-black"
...
function ProjectCard({ project, variants, compact = false }) {
  return (
    <motion.article
      ...
      className={`group relative bg-zinc-900 border border-gray-800 rounded-2xl overflow-hidden hover:border-blue-500/50 transition-all duration-300 ${
        compact ? "h-full" : ""
      }`}
      role="article"
